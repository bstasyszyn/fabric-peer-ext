...
func newTxFlags(block *common.Block) *txFlags {
	logger.Infof("Creating txFlags of length %d. Metadata length %d", len(block.Data.Data), len(block.Metadata.Metadata[common.BlockMetadataIndex_TRANSACTIONS_FILTER]))
