...
func (m *MockValidatorDiscovery) Group(groupName string, peers ...*MockPeer) *MockValidatorDiscovery {
	m.desc.PeersByGroups[groupName] = asDiscoveryPeers(peers)
	return m
}
...
func (m *MockValidatorDiscovery) PeersByPolicy(chainID common.ChannelID, policy policies.InquireablePolicy, filter func(member discimpl.NetworkMember) bool) (*gossipapi.PeerPolicyDescriptor, error) {
	return m.desc, m.err
}
