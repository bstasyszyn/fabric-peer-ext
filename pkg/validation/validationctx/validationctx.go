...
// ContextForBlock returns the context for the given block number
func (p *Provider) ContextForBlock(channelID string, blockNum uint64) (context.Context, error) {
	return p.get(channelID).create(blockNum)
}

// CancelContextForBlock cancels any outstanding validation for the given block number
func (p *Provider) CancelContextForBlock(channelID string, blockNum uint64) {
